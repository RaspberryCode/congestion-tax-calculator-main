...
The maximum amount per day and toableVehicle is 60 SEK.
...
A single charge rule applies in Gothenburg. Under this rule, a toableVehicle that passes several tolling stations within
60 minutes is only taxed once. The amount that must be paid is the highest one.
